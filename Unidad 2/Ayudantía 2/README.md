...
5. En caso de tener problemas de que eureka no inicia y además las aplicaciones que utilizan "@EnableEurekaClient" está en rojo. Se tiene que modificar el pom en el apartado de <properties>, fijarse que el <spring-cloud.version> esté en la versión **2020.0.3** para las aplicaciones que utilicen eureka y en eureka.
